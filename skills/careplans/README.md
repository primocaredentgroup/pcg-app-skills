...
Careplans operations use their own plan and operation permissions. Ticket assignment, comments and closure remain separate application workflows; an external ticket reference records context without authorizing a Careplans change.
