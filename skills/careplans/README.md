...
| Skill | Use |
| --- | --- |
| [`careplans-read-rows`](careplans-read-rows/SKILL.md) | Search plan rows, completed rows, pending-cleanup rows, ethics rows, restorable rows code rows and explicitly permitted operation history. |
